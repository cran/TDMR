...
#'
#' @seealso   \code{\link{dsetTrnVa.TDMdata}}, \code{\link{dsetTest.TDMdata}}, \code{\link{tdmReadDataset}}, \code{\link{tdmBigLoop}}
  ...
  tdm<-tdmDefaultsFill(tdm)
	if (opts$READ.INI) {
      ...
      ### (because each nExp requires a different split)
		...
		} else if (tdm$umode=="TST") {      # take the partition delivered by tdmReadDataset     
...
#' Read task data.
#'
#' Read and split task data (wrapper for \code{\link{tdmReadAndSplit}}).
#'      
#' @param tdm   list with TDMR controls 
#' @param envT  environment TDMR
#' @return \code{dataObj}, see \code{\link{tdmReadAndSplit}}
#' @seealso   \code{\link{dsetTrnVa.TDMdata}}, \code{\link{dsetTest.TDMdata}}, \code{\link{tdmReadAndSplit}}
#' @export
...
# checkData:
#     Helper fct for tdmReadAndSplit:
...
# splitTestTrnVa
#     Helper fct for tdmReadAndSplit, dsetTrnVa.TDMdata, dsetTest.TDMdata:
#
...
#'
#' @param x  return value from a prior call to \code{\link{tdmReadAndSplit}}, an object of class \code{\link{TDMdata}}.
...
#' @return \code{dset}, a data frame with all train-validation records
#'
#' @seealso   \code{\link{dsetTest.TDMdata}} \code{\link{tdmReadAndSplit}}
#' @export
...
#'
#' @seealso   \code{\link{unbiasedRun}} \code{\link{dsetTrnVa.TDMdata}} \code{\link{tdmReadAndSplit}}
#' @export
#' @author Wolfgang Konen, THK
