...
source.tdm <- function(tdmPath, tdmParallelCPUs=1,theSpotPath=NA,theRsfaPath=NA) {
  ...
  if(!tdmParallel){
    ...
    source(createSourcePath("defaultSC.R"))
    source(createSourcePath("defaultOpts.R"))
    ...
    source(createSourcePath("tdmReadDataset.r"))
    source(createSourcePath("tdmReadAndSplit.r"))
    ...
    source(createSourcePath("tdmTuneIt.r"))
    source(createSourcePath("tdmStartSpot2.r"))
